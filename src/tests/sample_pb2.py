...
class MessageOfTypes(with_metaclass(_reflection.GeneratedProtocolMessageType, _message.Message)):
  class NestedType(with_metaclass(_reflection.GeneratedProtocolMessageType, _message.Message)):
...
class NestedExtension(with_metaclass(_reflection.GeneratedProtocolMessageType, _message.Message)):
